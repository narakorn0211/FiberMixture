...
levels(metadata$fiber)
metadata$fiber.ord = factor(metadata$fiber, c("AX", "AXOS", "BLANK", "BRS", "CG", "FOS", "GOS", "H7", "INITIAL", "inulin", "KGLUCO", "MIX_1", "MIX_2", "MIX_3", "PEC"))
levels(metadata$fiber.ord)
...
my_column <- "fiber"  #this is the metadata column that we will use in the taxa barplot
my_column_ordered <- c("AX", "AXOS", "BLANK", "BRS", "CG", "FOS", "GOS", "H7", "INITIAL", "inulin", "KGLUCO", "MIX_1", "MIX_2", "MIX_3", "PEC")
...
diagdds = phyloseq_to_deseq2(physeq_deseq, ~ fiber)
...
run_deseq2("fiber", "MIX_1", "AX")
run_deseq2("fiber", "MIX_1", "AXOS")
run_deseq2("fiber", "MIX_1", "BLANK")
run_deseq2("fiber", "MIX_1", "BRS")
run_deseq2("fiber", "MIX_1", "CG")
run_deseq2("fiber", "MIX_1", "FOS")
run_deseq2("fiber", "MIX_1", "GOS")
run_deseq2("fiber", "MIX_1", "H7")
run_deseq2("fiber", "MIX_1", "INITIAL")
run_deseq2("fiber", "MIX_1", "inulin")
run_deseq2("fiber", "MIX_1", "KGLUCO")
run_deseq2("fiber", "MIX_1", "MIX_2")
run_deseq2("fiber", "MIX_1", "MIX_3")
run_deseq2("fiber", "MIX_1", "PEC")

run_deseq2("fiber", "MIX_2", "AX")
run_deseq2("fiber", "MIX_2", "AXOS")
run_deseq2("fiber", "MIX_2", "BLANK")
run_deseq2("fiber", "MIX_2", "BRS")
run_deseq2("fiber", "MIX_2", "CG")
run_deseq2("fiber", "MIX_2", "FOS")
run_deseq2("fiber", "MIX_2", "GOS")
run_deseq2("fiber", "MIX_2", "H7")
run_deseq2("fiber", "MIX_2", "INITIAL")
run_deseq2("fiber", "MIX_2", "inulin")
run_deseq2("fiber", "MIX_2", "KGLUCO")
run_deseq2("fiber", "MIX_2", "MIX_3")
run_deseq2("fiber", "MIX_2", "PEC")

run_deseq2("fiber", "MIX_3", "AX")
run_deseq2("fiber", "MIX_3", "AXOS")
run_deseq2("fiber", "MIX_3", "BLANK")
run_deseq2("fiber", "MIX_3", "BRS")
run_deseq2("fiber", "MIX_3", "CG")
run_deseq2("fiber", "MIX_3", "FOS")
run_deseq2("fiber", "MIX_3", "GOS")
run_deseq2("fiber", "MIX_3", "H7")
run_deseq2("fiber", "MIX_3", "INITIAL")
run_deseq2("fiber", "MIX_3", "inulin")
run_deseq2("fiber", "MIX_3", "KGLUCO")
run_deseq2("fiber", "MIX_3", "PEC")
